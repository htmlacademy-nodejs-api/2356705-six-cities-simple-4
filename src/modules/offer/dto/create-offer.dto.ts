...
import { IsArray, IsDateString, IsEnum, IsInt, IsMongoId, Max, MaxLength, Min, MinLength, IsBoolean, IsNumber, ArrayMinSize, ArrayMaxSize, ArrayUnique, IsObject, ValidateNested, IsLatitude, IsLongitude, IsString } from 'class-validator';
...
export default class CreateOfferDto {
  ...
  @IsDateString({}, { message: 'Field postDate must be valid ISO date' })
